#!/usr/bin/env python3
"""
Add Top 20 estimates to the category comparison files by interpolating
...
def add_top20_to_comparison(platform="android"):
    """Add Top 20 estimates to the comparison file"""
    input_file = f"remitly_category_comparison_{platform}.csv"
    output_file = f"remitly_category_comparison_{platform}_with_top20.csv"
...
if __name__ == "__main__":
    print("=" * 80)
    print("Adding Top 20 Estimates")
    print("=" * 80)
    
    android_df = add_top20_to_comparison("android")
    ios_df = add_top20_to_comparison("iphone")
    
    print("\n" + "=" * 80)
    print("COMPLETE")
    print("=" * 80)
    print("\nFiles created:")
    print("  - remitly_category_comparison_android_with_top20.csv")
    print("  - remitly_category_comparison_iphone_with_top20.csv")
